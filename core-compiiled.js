    ...
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
                ...
                if (0 >= n) c[e](g), k();
                    ...
                    if (c.css("transition-property").match(/(^|\s|,)-xf-(width|height)($|\s|,)/)) {
                        ...
                        var t = f[k],
                            ...
                            u;
                        if (void 0 === q)
                            for (q = {}, u = 0; u < t.length; u++) q[t[u]] = w[t[u]] || "";
                        if (0 == c[k]())
                        ...
                        q = t[k];
                        if (0 == c[k]())
                            for (u in q = "0", t) t.hasOwnProperty(u) && (t[u] = "0");
                        c[h](g);
                        if (B != q) {
                            var C = m;
                            c.css(A);
        ...
        unparseBbCode: function(a) {
            ...
            b.find(".bbCodeBlock--code").each(function() {
                ...
                var e = b.attr("class").match(/language-(\S+)/)[1];
                b.removeAttr("class");
        ...
        defaultAjaxError: function(a, b, c) {
            ...
            console.error("PHP: " +
                a.responseText);
            XF.alert(XF.phrase("a7la7ekaya1"))
        },
        activate: function(a) {
        ...
        function a(a) {
            for (var b = 0; b < e.length && a != e[b]; b++)
                if (f == e[b]) return !0;
            return !1
        }
        ...
        var a, b, c, f, e, g, l = !1,
            ...
            x = function(m) {
                ...
                for (var x = 0; x < h; x++) {
                    ...
                    var y = b - w + n;
                    var u = p.xfDynType; - 2 > y ? (y = w - (b + n), 60 > y ? "futureMoment" != u && (q.text(XF.phrase("in_a_moment")), p.xfDynType = "futureMoment") : 120 > y ? "futureMinute" != u && (q.text(XF.phrase("in_a_minute")), p.xfDynType = "futureMinute") : 3600 > y ? (w = Math.floor(y / 60), u !== "futureMinutes" + w && (q.text(XF.phrase("in_x_minutes", {
                        "{minutes}": w
                ...
                if (XF.config.enableRtnProtect && !a.isDefaultPrevented()) {
                    ...
                    if (c && (!c.match(/^[a-z]:/i) || c.match(/^https?:/i)) && !b.is("[data-fancybox]")) {
                        ...
                        if (!(b.closest("[contenteditable=true]").length || (c = XF.canonicalizeUrl(c), (new RegExp("^[a-z]+://" + location.host + "(/|$|:)", "i")).test(c) || g && g == a.timeStamp || (b.data("blank-handler-last", a.timeStamp), l = navigator.userAgent, b = -1 !== l.indexOf("MSIE"), g = -1 !== l.indexOf("Safari") && -1 == l.indexOf("Chrome"), l = -1 !== l.indexOf("Gecko/"), a.shiftKey && l || g && (a.shiftKey || a.altKey) || b)))) {
                            if (g) b = d('<iframe style="display: none" />').appendTo(k.body), g = b[0].contentDocument || b[0].contentWindow.document, g.__href = c, c = d("<script />", g), c[0].text = "window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;", g.body.appendChild(c[0]), b.remove();
                            else {
                                c = h.open(c);
                                try {
                                    c.opener = null
        ...
        __construct: function(a, b) {
            ...
            this.$container = d('<div class="overlay-container is-active" id="js-XFUniqueId113"><div class="overlay" tabindex="-1" role="dialog" aria-hidden="false"><div class="overlay-title"><a class="overlay-titleCloser js-overlayClose" role="button" tabindex="0" aria-label="إغلاق"></a>دخول</div><div class="overlay-content"><div class="blocks"><form action="/login.forum?redirect=/" method="post" onsubmit="md5hash(vb_login_password, vb_login_md5password, vb_login_md5password_utf, 0)" class="block"><div class="block-container"><div class="block-body"><dl class="formRow formRow--input"><dt><div class="formRow-labelWrapper"><label class="formRow-label" for="_xfUid-1-1611745501">اسمك أو عنوان بريدك الإلكتروني</label></div></dt><dd><input type="text" class="input" name="username" autofocus="autofocus" autocomplete="username" id="post"></dd></dl><dl class="formRow formRow--input"><dt><div class="formRow-labelWrapper"><label class="formRow-label" for="_xfUid-2-1611745501">كلمة المرور</label></div></dt><dd><div data-xf-init=" password-hide-show" data-show-text="Show" data-hide-text="Hide"><div class="inputGroup inputGroup--joined"><input type="password" name="password" value="" class="input js-password input--passwordHideShow" autocomplete="current-password" id="post"><div class="inputGroup-text"><label class="iconic iconic--hideShow js-hideShowContainer"><input type="checkbox" value="1"><i aria-hidden="true"></i><span class="iconic-label">Show</span></label></div></div></div><a href="/lost-password/" data-xf-click="overlay">نسيت كلمة مرورك؟</a></dd></dl><dl class="formRow"><dt><div class="formRow-labelWrapper"></div></dt><dd><ul class="inputChoices"><li class="inputChoices-choice"><label class="iconic"><input type="checkbox" name="remember" value="1" checked="checked"><i aria-hidden="true"></i><span class="iconic-label">البقاء متصلاً</span></label></li></ul></dd></dl><input type="hidden" name="_xfRedirect" value="https://www.aqarcity.com/"></div><dl class="formRow formSubmitRow"><dt></dt><dd><div class="formSubmitRow-main"><div class="formSubmitRow-bar"></div><div class="formSubmitRow-controls"><button type="submit" name="login" class="button--primary button button--icon button--icon--login"><span class="button-text">تسجيل الدخول</span></button></div></div></dd></dl></div><div class="block-outer block-outer--after"><div class="block-outer-middle">ليس لديك حساب؟ <a href="/login/register" class="button"><span class="button-text">سجل الآن</span></a></div></div><input type="hidden" name="_xfToken" value="1611745501,3de8d16cc696595b03ce58d636248f24"></form></div></div></div></div>
').html(this.$overlay);
        ...
        return {
            initialize: function() {
                XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ? e = new Promise(function(a, b) {
                    ...
                    else if (a = b.type, b = b.payload, "string" !== typeof a || "" === a) console.error("Invalid message type:", a);
        ...
        var a = new XF.ClassMapper,
            ...
            f = XF.create({
                ...
                _init: function() {
                    var a = new d.Event("xf-" +
                            this.eventType + ":before-init." + this.eventNameSpace),
                        b = !1;
        ...
        if (b.switchKey) {
            ...
            if (f) {
                for (var e, g; e = f.match(/(\s*,)?\s*(addClass|removeClass|titleAttr):([^,]+)(,|$)/);)
                    if (f = f.substring(e[0].length), g = c.trim(e[3]), g.length) switch (e[2]) {
                        case "addClass":
                            a.addClass(g);
                            break;
                        case "removeClass":
        ...
        submit: function(a) {
            ...
            if (e) {
                if (this.options.jsonName) {
                    ...
                    XF.alert(XF.phrase("a7la7ekaya2"));
                    return
                }
        ...
        submitResponse: function(a, b, d) {
            if ("object" != typeof a) XF.alert("Response was not JSON.");
                ...
                if (!e.isDefaultPrevented()) {
                    ...
                    }), h = !0) : XF.redirect(a.redirect) : (XF.flashMessage(a.message, 3E3), h = !0), k && k.trigger("overlay:hide");
                    else if (a.html) {
                        var g = this;
...
! function(d, f, h) {
    ...
    XF.MenuClick = XF.Event.newHandler({
        ...
        getHorizontalPosition: function(a, b) {
            ...
            e = Math.min(e, a.right - this.menuWidth -
                this.menuRef.left - 5);
        ...
        init: function() {
            ...
            if (a.length) {
                ...
                this.$goEnd = d('<i class="' +
                    k + " " + k + '--end" aria-hidden="true" />').click(function() {
                    e.step(1)
                }).insertAfter(a);
                this.updateScroll();
                ...
                if (l.length) {
                    ...
                    m = m.left;
                    l = m + l;
                    XF.isRtl() ? 80 > m && a.normalizedScrollLeft(-l + k - 50) : l > k && (l + 80 > k ? a.normalizedScrollLeft(m - 50) : a.normalizedScrollLeft(m -
                        80))
                }
            ...
            if (this.supportsSticky) {
                var e = !1,
                    ...
                    h, m = function(c) {
                        ...
                        d < k || d == k && 0 < f.scrollY ? e || (a.addClass(b), e = !0) : e && (g && c ? (clearTimeout(h), h = setTimeout(function() {
                            m(!1)
